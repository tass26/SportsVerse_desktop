...
public class User {
    ...
    public User(int id, String nom, String prenom, String adresse, String num_tel, String email) {
        this.id = id;
        this.nom = nom;
        this.prenom = prenom;
        this.adresse = adresse;
    ...
    public User(int id, String nom, String prenom, String adresse, String num_tel, String email, String password, String role) {
        this.id = id;
        this.nom = nom;
        this.prenom = prenom;
        this.adresse = adresse;
    ...
    public User(int id, String nom, String email, String role, String is_banned) {
        this.id = id;
        this.nom = nom;
        this.email = email;
        this.role = role;
    ...
    public String toString() {
        return "User{" + "id=" + id +  ", nom=" + nom + ", prenom=" + prenom + ", adresse=" + adresse + ", num_tel=" + num_tel + ", email=" + email + ", password=" + password + ", role=" + role +  '}';
    }
